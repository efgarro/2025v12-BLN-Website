...
export const ImageClusterGrid: React.FC<Props> = ({ dataPics, layouts = {}, rowHeight = 150 }) => {
  ...
  return (
    <div ref={containerRef}>
      ...
      <Modal
        ...
        onClose={closeModal}
        title={undefined}
        footer={selectedImage?.description ? <div className="px-2">{selectedImage.description}</div> : null}
      >
        {selectedImage && (
          <div className="flex items-center justify-center w-full">
            <img
              ...
              className="max-w-[95vw] max-h-[75vh] w-auto h-auto object-contain rounded shadow-lg"
            />
          </div>
        )}
      </Modal>
