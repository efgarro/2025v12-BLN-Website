  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute right-3 top-3 z-20 inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/35 text-gray-700 hover:bg-white focus:outline-none focus:ring-2 touch-manipulation"
      >
        <svg
          className="h-5 w-5"
          viewBox="0 0 24 24"
