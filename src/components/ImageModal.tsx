...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, footer }) => {
  ...
  // swipe down to close (gentle threshold)
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-[98vw] bg-white rounded overflow-hidden shadow-xl"
        style={{
          WebkitOverflowScrolling: "touch",
          // use the --vh trick so 100vh behaves correctly on mobile browsers:
      ...
      >
        ...
        {/* inner content (stop click propagation so taps/pinch don't close) */}
        <div
          className="flex flex-col items-center justify-center w-full overflow-auto p-2 sm:p-4"
