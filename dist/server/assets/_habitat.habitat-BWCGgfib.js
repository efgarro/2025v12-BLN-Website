import { p as jsxRuntimeExports, c as reactExports, G as ClientOnly } from "./worker-entry-DOKHgtWa.js";
import { C as CardEatdo } from "./CardEatdo-DA2dAAWz.js";
import { C as CardGrounds } from "./CardGrounds-C8lqscKL.js";
import { C as CardRooms } from "./CardRooms-Cc5Hnf2H.js";
import "node:events";
import "node:stream";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "article_wrapper mt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card bg-base-100 w-auto shadow-sm rounded-none mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-body bg-bln-azul-arena", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "prose lg:prose-lg", children: [
          "The pride and joy of BijaLapa Natural is the Scarlet Macaw Habitat Project which has a simple premise;",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { children: "plant trees and wildlife will come" }) }),
          ". So, for ten years straight, one hundred trees (or more) per year have been planted, and not only the majestic Scarlet Macaw has come to reap the benefits, but many other forms of wildlife too."
        ] }) })
      ] }),
