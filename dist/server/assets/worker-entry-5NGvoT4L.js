...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-cm67PjM5.js");
...
async function loadEntries() {
  const routerEntry = await import("./router-D6hqw19b.js").then((n2) => n2.r);
...
export {
  ReadStream as A,
  notImplemented as B,
  notImplementedClass as C,
  notImplementedAsync as D,
