import { B as getAugmentedNamespace, E as requireReact, l as requireReactDom, w as React, j as jsxRuntimeExports, r as reactExports } from "./worker-entry-Bo-hniRQ.js";
import { z as useGetImageMix } from "./apiFns-DLX3UpCN.js";
...
class ImageClusterGrid extends React.Component {
  render() {
    return (
...
const ImageCluster = (image_mix_name) => {
  ...
  reactExports.useEffect(() => {
    const generateLayoutLg = () => {
      return dataPics.map((item, index2) => {
        return {
          x: (index2 + 3) % 3 * 4,
          y: 0,
          w: 4,
