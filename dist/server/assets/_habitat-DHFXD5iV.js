import { p as jsxRuntimeExports, O as Outlet } from "./worker-entry-DOKHgtWa.js";
import { u as useNavSettings } from "./router-B2t0vaOv.js";
import "node:events";
import "node:stream";
...
const MenuBarGrounds = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core_flexRow justify-center mt-2 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "menu menu-vertical gap-1 md:menu-horizontal md:px-1 md:gap-2", children: [
