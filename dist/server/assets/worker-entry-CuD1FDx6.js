...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-n5uOZ0Uk.js");
...
async function loadEntries() {
  const routerEntry = await import("./router-w7Vgpazk.js").then((n2) => n2.r);
  return {
