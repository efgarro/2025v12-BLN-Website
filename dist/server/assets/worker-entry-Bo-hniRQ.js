...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./_tanstack-start-manifest_v-DywLHMPh.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./_tanstack-start-server-fn-manifest_v-OTOll91b.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-DQbY8BHo.js").then((n) => n.r);
    }
    if (startEntry === null) {
...
export {
  ...
  requireReactDom as l,
  matchContext as m,
  useForwardedRef as n,
  useIntersectionObserver as o,
  functionalUpdate as p,
  exactPathTest as q,
  reactExports as r,
