...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CWthbCoc.js");
...
async function loadEntries() {
  const routerEntry = await import("./router-B2t0vaOv.js").then((n2) => n2.r);
