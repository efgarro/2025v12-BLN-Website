...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./_tanstack-start-manifest_v-BtlEiby5.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./_tanstack-start-server-fn-manifest_v-8B5NOsJr.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-DQ0CsUOz.js").then((n) => n.r);
    }
    if (startEntry === null) {
