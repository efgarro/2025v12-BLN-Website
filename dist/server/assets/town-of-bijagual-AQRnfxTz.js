import { r as reactExports, n as jsxRuntimeExports } from "./worker-entry-D3zVgP0m.js";
import { b as Route } from "./router-Bp1FaMTG.js";
import "node:events";
import "node:stream";
...
function EmblaCarousel$1(root, userOptions, userPlugins) {
...
function useEmblaCarousel(options = {}, plugins = []) {
  ...
  reactExports.useEffect(() => {
    if (canUseDOM() && viewport) {
      EmblaCarousel$1.globalOptions = useEmblaCarousel.globalOptions;
      const newEmblaApi = EmblaCarousel$1(viewport, storedOptions.current, storedPlugins.current);
...
const usePrevNextButtons = (emblaApi) => {
  const [prevBtnDisabled, setPrevBtnDisabled] = reactExports.useState(true);
  const [nextBtnDisabled, setNextBtnDisabled] = reactExports.useState(true);
  const onPrevButtonClick = reactExports.useCallback(() => {
    if (!emblaApi) return;
    emblaApi.scrollPrev();
  }, [emblaApi]);
  const onNextButtonClick = reactExports.useCallback(() => {
    if (!emblaApi) return;
    emblaApi.scrollNext();
  }, [emblaApi]);
...
const PrevButton = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      ...restProps,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "embla__button__svg", viewBox: "0 0 532 532", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "path",
          {
            fill: "currentColor",
...
const useDotButton = (emblaApi) => {
  ...
  const [scrollSnaps, setScrollSnaps] = reactExports.useState([]);
  const onDotButtonClick = reactExports.useCallback(
    (index) => {
      if (!emblaApi) return;
  ...
  const onInit = reactExports.useCallback((emblaApi2) => {
...
const EmblaCarousel = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "embla", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "embla__viewport", ref: emblaRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "embla__container", children: slides.map((index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "embla__slide core_flexCol", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("figcaption", { className: "text-center text-sm mt-2", children: index.figcaption })
    ] }, index.id)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "embla__controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "embla__buttons", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PrevButton, { onClick: onPrevButtonClick, disabled: prevBtnDisabled }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NextButton, { onClick: onNextButtonClick, disabled: nextBtnDisabled })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "embla__dots", children: scrollSnaps.map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        DotButton,
        {
...
const singles = [{
  ...
  orientation: "por",
  description: "Bijagual Waterfall with viewpoint positioned at the bottom of the waterfall with visitors in the foreground",
  ...
  url: "https://r2storage.bijalapa.com/hiking/8910fd6b67f2_bijagual-waterfall-at-second-entrance-private-reserve.jpg",
  orientation: "por",
  description: "The lodge building lighted at night features two side-by-side mirrored rooms sharing a balcony",
  figcaption: "Rushing Water at Second Entrance"
}, {
  ...
  orientation: "lan",
  description: "The room bathroom is a mixture of modern fixtures and materials and traditional handcrafted furniture",
  ...
  orientation: "lan",
  description: "The Guarumo Room features two full-size handcrafted beds, framed paintings on the wall and large windows with French doors",
  figcaption: "Interior Guarumo at Second Entrance"
}];
function RouteComponent() {
  Route.useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "article_wrapper mt-8 mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmblaCarousel, { slides: singles, options: OPTIONS }) }) });
}
export {
