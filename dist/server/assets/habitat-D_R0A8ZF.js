...
const MenuBarGrounds = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core_flexRow justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "menu menu-vertical gap-1 md:menu-horizontal md:px-1 md:gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex-1 justify-center bg-[#FFF440]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "flex h-13 w-50 justify-center font-semibold text-[#3A3E40]", href: "/grounds/yard", children: "Wildlife Journal" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex-1 justify-center bg-[#F000D0]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "flex w-50 justify-center text-center font-semibold text-white", href: "/grounds/ranch", children: "One Hundred Trees per Year (...and counting)" }) })
  ] }) });
};
