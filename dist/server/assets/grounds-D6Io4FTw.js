...
const MenuBarGrounds = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "core_flexRow justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "menu menu-vertical gap-1 md:menu-horizontal md:px-1 md:gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "flex-1 bg-[#A8E200]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "flex h-13 w-36 justify-center font-semibold text-[#3A3E40]", href: "/grounds/ranch", children: "Meet Organic" }) })
  ] }) });
};
function Grounds() {
