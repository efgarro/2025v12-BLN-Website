...
async function loadVirtualModule(id) {
  switch (id) {
    case VIRTUAL_MODULES.startManifest:
      return await import("./_tanstack-start-manifest_v-CP0Gx-p4.js");
    case VIRTUAL_MODULES.serverFnManifest:
      return await import("./_tanstack-start-server-fn-manifest_v-C2eHpZ1C.js");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-BQRv1Uho.js").then((n) => n.r);
    }
    if (startEntry === null) {
...
export {
  ...
  matchContext as p,
  useForwardedRef as q,
  reactExports as r,
  useIntersectionObserver as s,
  trimPathLeft as t,
  useRouter as u,
